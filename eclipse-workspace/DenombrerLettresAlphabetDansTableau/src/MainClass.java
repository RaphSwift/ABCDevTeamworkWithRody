...
public class MainClass {
	public static void main(String[] args) {
		String maChaineATester="il était une fois, dans la ville de foix, une marchande de foie, qui vendais du foie, elle se dit 'ma foi, c'est la premiere fois et la dernière fois que je vens du foie dans la ville de foix'";
